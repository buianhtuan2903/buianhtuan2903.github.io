var makeItRain = function() {
    ...
    while (increment < 85) {
      ...
      //increment
      increment += (Math.floor(Math.random() * (14 - 1 + 1) + 1));
      //add in a new raindrop with various randomizations to certain CSS properties
      drops += '<div class="drop" style="left: ' + increment + '%; bottom: ' + (randoFiver + randoFiver + 120) + '%; animation-delay: 0.' + randoHundo + 's; animation-duration: 0.' + randoHundo + 's;"><div class="stem" style="animation-delay: 0.' + randoHundo + 's; animation-duration: 0.' + randoHundo + 's;"></div></div>';
